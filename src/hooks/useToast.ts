...
export const toast = {
  success: (message: string, duration?: number) =>
    globalToastFunction?.success(message, duration),
  error: (message: string, duration?: number) =>
    globalToastFunction?.error(message, duration),
  warning: (message: string, duration?: number) =>
    globalToastFunction?.warning(message, duration),
  info: (message: string, duration?: number) =>
    globalToastFunction?.info(message, duration),
  show: (message: string, type?: ToastType, duration?: number) =>
    globalToastFunction?.show(message, type, duration),
};
